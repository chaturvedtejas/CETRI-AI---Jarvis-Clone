...
powershell " = New-Object -comObject WScript.Shell;  = .CreateShortcut('%USERPROFILE%\Desktop\CETRI AI Assistant.lnk'); .TargetPath = '%USERPROFILE%\CETRI_AI\CETRI_AI_Assistant.exe'; .WorkingDirectory = '%USERPROFILE%\CETRI_AI'; .IconLocation = '%%SystemRoot%%\system32\SHELL32.dll,13'; .Save()"
...
powershell " = New-Object -comObject WScript.Shell;  = .CreateShortcut('%APPDATA%\Microsoft\Windows\Start Menu\Programs\CETRI AI\CETRI AI Assistant.lnk'); .TargetPath = '%USERPROFILE%\CETRI_AI\CETRI_AI_Assistant.exe'; .WorkingDirectory = '%USERPROFILE%\CETRI_AI'; .IconLocation = '%%SystemRoot%%\system32\SHELL32.dll,13'; .Save()"
